...
namespace wx.Util
{
    public class Oauth2
    {
        ...
        public static string GetCodeUrl(string Appid, string redirect_uri, string scope)
        {
        ...
        public static string CodeGetOpenid(string Appid, string Appsecret, string Code)
        {
            ...
            string ReText = HttpRequestUtil.RequestUrl(url);//post/get方法获取信息 
        ...
        public string GetUserInfo(string Appid, string Appsecret, string Code)
        {
            ...
            {
                return HttpRequestUtil.RequestUrl("https://api.weixin.qq.com/sns/userinfo?access_token=" + DicText["access_token"] + "&openid=" + DicText["openid"] + "&lang=zh_CN");
            }
        }
    }
}